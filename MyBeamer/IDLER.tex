...
\begin{frame}{INTRODUCTION}%{BACKGROUND}
	\begin{exampleblock}{Challenge}
		...
		a lot inherent difficulties brought by 2D vision based systems, especially the inaccuracy in determining sizes, distances and orientations for visual objects. 
	\end{exampleblock}
	\pause
	\begin{exampleblock}{RGB-D Data}
...
\begin{frame}{Registration}
	\begin{exampleblock}{Generate Points Cloud Data}
		\begin{figure}[htpb]
			...
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./Picture/Example/before-match.eps} }
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.6in, height=.35in]{./Picture/Material/arrow.jpg} }
				\centerline{\tiny{Registering}}
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./Picture/Example/match.eps} }
			\end{minipage}
		\end{figure}
	\end{exampleblock}
	\begin{exampleblock}{Flow}
