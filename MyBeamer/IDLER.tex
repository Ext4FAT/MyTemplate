...
\begin{frame}{Object detector training}
	...
	\begin{exampleblock}{Train SVM classifier with One Vs Rest strategy}
		\begin{itemize}
			\item Saved as \fbox{\textbf{${Classifier}_{obj}$}}
		\end{itemize} 
	\end{exampleblock}
\end{frame}
...
\begin{frame}{Segmentation}
	...
	\begin{exampleblock}{\small{Step 1: Rough Segment}}
		\begin{itemize}
			\item 	$\left \langle BCR, DCR \right \rangle \leftarrow$ Region-Growing($Depth$)
...
\begin{frame}{Evaluation Criteria}
	...
	\begin{exampleblock}{Compare with different registration methods}
		\centering{
			\includegraphics[width=\textwidth, height=1.9in]{./Picture/Example/table.png}
		}
	\end{exampleblock}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
