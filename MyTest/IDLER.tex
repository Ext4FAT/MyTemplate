...
\begin{frame}{Proposed framework for robotic grasping}
	...
	\centering{
	\includegraphics[height=2.16in,width=4.68in]{flow.eps}
	}
...
\begin{frame}{Segmentation}
	\begin{exampleblock}{Flow}
		\begin{figure}[htpb]
			\centering
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./depth.eps} }
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.6in, height=.45in]{./arrow.jpg} }
				\centerline{\tiny{region-growing}}
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./merge.eps} }
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.6in, height=.45in]{./arrow.jpg} }
			...
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./seg.eps} }
			\end{minipage}
		\end{figure}
	\end{exampleblock}
...
\begin{frame}{Classification}
	\begin{exampleblock}{Flow}
		\begin{figure}[htpb]
			\centering
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./color.eps} }
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.6in, height=.45in]{./arrow.jpg} }
			...
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./regions.eps} }
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.6in, height=.45in]{./arrow.jpg} }
			...
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./classification.eps} }
			\end{minipage}
		\end{figure}
	\end{exampleblock}
	\begin{exampleblock}{Input}
...
\begin{frame}{Registration}
	\begin{exampleblock}{Generate Points Cloud Data}
		\begin{figure}[htpb]
			\centering
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./pointcloud.eps} }
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \quad}
				\centerline{ \includegraphics[width=0.6in, height=.45in]{./arrow.jpg} }
			...
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./before-match.eps} }
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.6in, height=.45in]{./arrow.jpg} }
			...
			\end{minipage}
			\begin{minipage}[b]{0.8in}
				\centerline{ \includegraphics[width=0.8in, height=.65in]{./match.eps} }
			\end{minipage}
		\end{figure}
	\end{exampleblock}
	\begin{exampleblock}{Flow}
...
\begin{frame}{Localization}
	\begin{exampleblock}{Result}
		\centering{
			\includegraphics[width=2.7in]{./reflect.eps}
		}
		\begin{itemize}
