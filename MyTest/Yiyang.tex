...
\begin{frame}{Proposed framework for robotic grasping}
	...
	\centering{
	\includegraphics[height=1.8in]{flow.eps}
	}
		...
		\begin{figure}[htpb]
			...
			\subfigure[Cup]{
				\begin{minipage}[b]{0.8in}
					\includegraphics[width=0.8in, height=.65in]{cup.eps}
				\end{minipage}
			}
			\subfigure[Can]{
				\begin{minipage}[b]{0.8in}
					\includegraphics[width=0.8in, height=.65in]{can.eps}
				\end{minipage}
			}
			\subfigure[Teapot]{
				\begin{minipage}[b]{0.8in}
					\includegraphics[width=0.8in, height=.65in]{pot.eps}
				\end{minipage}
			}
			\subfigure[Box]{
				\begin{minipage}[b]{0.8in}
					\includegraphics[width=0.8in, height=.65in]{box.eps}
				\end{minipage}
			}
			\subfigure[Bottle]{
				\begin{minipage}[b]{0.8in}
					\includegraphics[width=0.8in, height=.65in]{bottle.eps}
				\end{minipage}
			}
...
\subsection{Results}
\begin{frame}{Results}
	\begin{exampleblock}{Experiment of Comparison different registration methods}
		\centering{
			\includegraphics[height=1.8in]{table.png}
		}
	\end{exampleblock}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
